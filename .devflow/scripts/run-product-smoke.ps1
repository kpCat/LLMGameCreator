...
function Write-ProductSmokeSummary {
    ...
    } elseif ($Scenario -eq "minimum-playable-generated-game") {
        Join-Path $ScenarioArtifactRoot ".llmgc\procedural\minimum-playable-generated-game\minimum-playable-generated-game-report.json"
    } elseif ($Scenario -eq "generated-game-profile-contract") {
    ...
    } elseif ($Scenario -eq "package-assembly-dialogue-quests") {
        Join-Path $ScenarioArtifactRoot ".llmgc\procedural\package-assembly-dialogue-quests\package-assembly-dialogue-quests-report.json"
    } elseif ($Scenario -eq "package-assembly-items-economy-crafting") {
        Join-Path $ScenarioArtifactRoot ".llmgc\procedural\package-assembly-items-economy-crafting\package-assembly-items-economy-crafting-report.json"
    } elseif ($Scenario -eq "package-assembly-combat-progression") {
        Join-Path $ScenarioArtifactRoot ".llmgc\procedural\package-assembly-combat-progression\package-assembly-combat-progression-report.json"
...
elseif ($Scenario -eq "unity-archive-review-snapshot") {
    ...
    elseif ($Scenario -eq "minimum-playable-generated-game") {
        $TestFilter = "FullyQualifiedName~MinimumPlayableGeneratedGameProductSmoke"
    }
    elseif ($Scenario -eq "generated-game-profile-contract") {
        $TestFilter = "FullyQualifiedName~GeneratedGameProfileContractProductSmoke"
    }
    elseif ($Scenario -eq "development-complexity-stabilization") {
    ...
    elseif ($Scenario -eq "package-assembly-dialogue-quests") {
        $TestFilter = "FullyQualifiedName~PackageAssemblyDialogueQuestsProductSmoke"
    }
    elseif ($Scenario -eq "package-assembly-items-economy-crafting") {
        $TestFilter = "FullyQualifiedName~PackageAssemblyItemsEconomyCraftingProductSmoke"
    }
    elseif ($Scenario -eq "package-assembly-combat-progression") {
        $TestFilter = "FullyQualifiedName~PackageAssemblyCombatProgressionProductSmoke"
    }
    else {
