...
public sealed class GeneratedMicrogameChallengeLoopSmokeTests
{
    [Fact]
    public async Task GeneratedMicrogameChallengeLoopProductSmoke()
    {
        ...
        var result = await service.ExecuteAsync(new OneClickGeneratedPreviewWorkflowRequest
        {
            ...
            Seed = "product-smoke-generated-microgame-challenge-loop",
