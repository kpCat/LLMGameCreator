...
public sealed class PackageAssemblyDialogueQuestsSmokeTests
{
    [Fact]
    public async Task PackageAssemblyDialogueQuestsProductSmoke()
    {
        ...
        Assert.Equal(PackageAssemblyDialogueQuestsAcceptanceService.FinalGate, report.FinalStatus);
        Assert.Equal(PackageAssemblyDialogueQuestsAcceptanceService.FinalGate, report.ManualGate);
        Assert.Equal(PackageAssemblyDialogueQuestsAcceptanceService.PreviousAcceptedGate, report.PreviousAcceptedGate);
        ...
        Assert.True(report.DialogueQuestMappingWritten);
