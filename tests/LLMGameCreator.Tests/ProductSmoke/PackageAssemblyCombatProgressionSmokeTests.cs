...
public sealed class PackageAssemblyCombatProgressionSmokeTests
{
    [Fact]
    public async Task PackageAssemblyCombatProgressionProductSmoke()
    {
        ...
        Assert.Equal(PackageAssemblyCombatProgressionAcceptanceService.FinalGate, report.FinalStatus);
        Assert.Equal(PackageAssemblyCombatProgressionAcceptanceService.FinalGate, report.ManualGate);
        Assert.Equal(PackageAssemblyCombatProgressionAcceptanceService.PreviousAcceptedGate, report.PreviousAcceptedGate);
        Assert.True(report.Goal027EvidenceVerified);
        Assert.True(report.Goal026EvidenceVerified);
        Assert.True(report.Goal025EvidenceVerified);
        ...
        Assert.True(report.CombatProgressionMappingWritten);
