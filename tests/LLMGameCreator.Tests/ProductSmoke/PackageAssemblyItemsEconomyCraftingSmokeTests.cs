...
public sealed class PackageAssemblyItemsEconomyCraftingSmokeTests
{
    [Fact]
    public async Task PackageAssemblyItemsEconomyCraftingProductSmoke()
    {
        ...
        Assert.Equal(PackageAssemblyItemsEconomyCraftingAcceptanceService.FinalGate, report.FinalStatus);
        Assert.Equal(PackageAssemblyItemsEconomyCraftingAcceptanceService.FinalGate, report.ManualGate);
        Assert.Equal(PackageAssemblyItemsEconomyCraftingAcceptanceService.PreviousAcceptedGate, report.PreviousAcceptedGate);
        ...
        Assert.True(report.ItemsEconomyCraftingMappingWritten);
