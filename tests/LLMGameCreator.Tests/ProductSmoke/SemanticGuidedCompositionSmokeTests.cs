...
public sealed class SemanticGuidedCompositionSmokeTests
{
    [Fact]
    public async Task SemanticGuidedCompositionProductSmoke()
    {
        ...
        var service = new SemanticGuidedCompositionAcceptanceService(goal004Service: goal004);
        ...
        Assert.Contains("\"manualGate\": \"semantic_guided_composition_artifact_verification\"", json);
        Assert.Contains("\"goal004RuntimeEvidencePreserved\": true", json);
