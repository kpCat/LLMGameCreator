...
public sealed class DevelopmentComplexityStabilizationTests
{
    ...
    public void StateDocsRecordGoal022AcceptedBeforeGoal023()
    {
        ...
        Assert.Equal("package_assembly_combat_progression_expansion_verification", state.RootElement.GetProperty("gate_status").GetString());
        Assert.Equal("goal_028_package_assembly_expansion_4_combat_progression", state.RootElement.GetProperty("last_completed_product_slice_id").GetString());
        ...
        Assert.Contains("package_assembly_combat_progression_expansion_verification", contextIndex);
    }
