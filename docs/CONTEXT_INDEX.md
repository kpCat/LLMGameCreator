...
1. Review `alpha_runnable_windows_build_verification` evidence from the produced Windows player, Unity build log, diagnostic launch log and automated play-loop log before marking the gate passed.
