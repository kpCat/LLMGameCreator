...
27. Keep Goal 069 World Event Weather Day/Night Crisis Matrix produced for review with `world_event_weather_daynight_crisis_matrix_verification required` until user acceptance; do not start the next goal.
