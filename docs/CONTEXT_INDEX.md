...
19. Review Goal 061 Full Campaign Playable Review Package RC while keeping `full_campaign_playable_review_package_rc_verification required` until user acceptance.
