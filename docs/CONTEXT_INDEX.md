...
Visual World Stream Preview Workspace. The active gate remains `offline_geoworld_alpha_manual_acceptance_verification
required`, `accepted=false`; the next human action is an explicit gate decision, not future feature work.
