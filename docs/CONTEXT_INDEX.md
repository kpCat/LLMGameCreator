...
28. Keep Goal 070 Integrated Campaign Timeline Simulation Matrix produced for review with `integrated_campaign_timeline_simulation_matrix_verification required` until user acceptance; do not start the next goal.
