...
25. Keep Goal 067 Programmatic Narrative Quest Dialogue Event Matrix produced for review with `programmatic_narrative_quest_dialogue_event_matrix_verification required` until user acceptance; do not start the next goal.
