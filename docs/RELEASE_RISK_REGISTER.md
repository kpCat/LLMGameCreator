...
Goal164 release-risk note: generated encounter participants are now bound at build time to an existing exact qualified combat contract from Lane A. No Runtime or campaign-time definition injection occurs. Every generated encounter is executable, persisted as `CAMPAIGN_CURRENT`, and survives regeneration, history rollback, save migration, standalone and portable recovery. Rich authored combat diversity and branching consequences remain future work. Runtime, public GamePackage, generated source/save migration, standalone implementation and Unity remain unchanged.
