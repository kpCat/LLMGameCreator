...
Produced for review: `constrained_spatial_detail_generation_verification required`.
...
```text
goal_062_constrained_spatial_detail_generation_review_until_constrained_spatial_detail_generation_verification_passes
```
