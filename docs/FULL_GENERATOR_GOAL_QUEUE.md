...
- Goal 168 choice-driven relationships and multi-quest arcs: `GREEN_ACCEPTABLE_CANDIDATE`, `accepted=false`, no manual gate, independent audit required. It closes Goal167 audit P1 `BLOCKED_AT_FD69BFC8` by reusing the exact Goal166 qualified-action catalog, including ability-only and utility-first routes. Exact generated dialogue IDs become relationships; generated quests are assigned once and progress through sequential Support dialogue/combat/manual-turn-in arcs. History v6, save continuation, explicit migration, one cached smoke, RC and portable profiles are GREEN.
