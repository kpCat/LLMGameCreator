...
Produced for review. The gate remains `unity_alpha_interactive_campaign_player_verification required`, `accepted=false`.
...
```text
unity_alpha_interactive_campaign_player_verification
```

Status:

```text
goal_071_unity_alpha_interactive_campaign_player_produced_for_review
```
