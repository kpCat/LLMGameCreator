...
- Goal 157 generated-world provenance and Runtime start activation: `GREEN_ACCEPTABLE_CANDIDATE`, `accepted=false`, no human gate. The Goal156 audit P1 is closed by strict request-to-chain regeneration and canonical Goal142 overlay/base rebuild. Generated builds now separate baseline-start AcceptedMechanics compatibility from a final player lane that starts, moves and interacts on the generated map. Next work is an independent Goal157 audit, then planning generated-region travel or seed regeneration.
