...
Updated by: Goal 023 capability bundle selection to pipeline inputs  
...
1. Review `capability_bundle_pipeline_inputs_verification` evidence from the Goal 023 contract, selector request artifact, generator input artifact, gap report, invalid/fake/leak matrix, report and verification artifact before marking the gate passed.
