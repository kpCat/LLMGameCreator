...
Updated by: Goal 022 development complexity stabilization and artifact scope governance  
...
1. Review `development_complexity_stabilization_verification` evidence from the stabilization policy, artifact-scope policy JSON, scope guard script, check-all isolation proof, tracked generated artifact inventory, invalid/fake/leak matrix, report and verification artifact before marking the gate passed.
