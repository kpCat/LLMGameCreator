...
Updated by: Goal 017 Unity generated quest completion loop  
...
The active gate is now `unity_generated_quest_completion_loop_verification` and remains required, not passed.
...
After Goal 017, this state should recommend:
