...
Updated by: Goal 015 Unity generated scene content projection  
...
The active gate is now `unity_generated_scene_content_projection_verification` and remains required, not passed.
...
After Goal 015, this state should recommend:
