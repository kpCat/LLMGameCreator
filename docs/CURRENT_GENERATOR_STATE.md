...
24. Keep Goal 066 Settlement Construction Destruction Production Matrix produced for review with `settlement_construction_destruction_production_matrix_verification required`; do not start Goal 067 until user acceptance.
