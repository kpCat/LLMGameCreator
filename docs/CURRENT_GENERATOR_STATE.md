...
Updated by: Goal 036 Lua sandbox execution gate production  
...
5. Recommend Goal 037 hybrid LLM draft plus Lua deterministic expansion only after Goal 036 review acceptance; do not start Goal 037 in this handoff.
...
Evidence source: Goal 036 implementation artifacts under `.llmgc/procedural/goal-036-lua-sandbox-execution-gate/`.
