...
public sealed class CombatMagicAbilityBossEncounterProjector
{
    ...
    private static class CombatProfiles
    {
        ...
        [
            FamilyProfile("map_panel_rpg", "tactical_faction_duel", "faction_champion", "sigil_break", "shield_rally", "council_oath", "duelist_guard", "marked_vulnerable", "faction_guarded", "elite_guard_break", "read_the_guard", "route_duel_finish", "guard broken by linked route pressure", "arcane_slash", "mana", "shield", "ritual_mark", "stance_switch", "brace_and_flank", "incoming strike reduced", "council_badge", "route_access", "faction_narrative_pressure", true, true, false, ["sigil_break", "banner_interdict", "oath_counter"], ["magic", "tactical", "faction"], ["marked_vulnerable", "inspired_guard", "oath_burn"], ["health", "status", "faction"], ["elite_guard_break", "oath_reversal"]),
            FamilyProfile("survival_sandbox", "hostile_hazard_creature_raid", "hazard_alpha", "ember_trap", "maul_pressure", "scarred_hide", "pack_hunger", "fatigue_burn", "enraged_hazard", "raid_hazard_escalation", "set_the_trap", "recover_and_salvage", "trap consumes crafted fuel and controls hazard", "fire_trap", "stamina", "hide", "cold_exposure", "crafted_countermeasure", "consume_repair_kit", "injury pressure reduced", "reinforced_tool", "camp_recovery", "survival_camp_recovery", true, true, true, ["ember_trap", "bandage_surge", "snare_pull"], ["hazard", "crafting", "survival"], ["fatigue_burn", "injury_stabilized", "warmth_buffer"], ["health", "status", "survival"], ["raid_hazard_escalation", "resource_starvation"]),
            FamilyProfile("first_person_grid_dungeon", "orientation_boss_trap_gate", "grid_warden", "rune_lance", "trap_pulse", "glyph_focus", "stone_skin", "rune_shock", "boss_channeling", "boss_trap_turn", "align_the_corridor", "open_the_glyph_gate", "rune lance interrupts a traversal-aware boss phase", "rune_damage", "energy", "ward", "rune_instability", "position_counter", "sidestep_and_interrupt", "trap pulse redirected", "glyph_key", "gate_unlock", "dungeon_route_memory", true, true, false, ["rune_lance", "ward_shatter", "glyph_guard"], ["magic", "boss", "grid"], ["rune_shock", "orientation_focus", "trap_slow"], ["health", "status", "position"], ["boss_trap_turn", "glyph_gate_shift"])
        ];
