...
internal static class VisualChunkCacheUnityStreamingAssetsHandoffJson
{
...
internal static class VisualChunkCacheUnityStreamingAssetsHandoffHash
{
    ...
    public static string HashJson<T>(T value) =>
        Sha256Text(VisualChunkCacheUnityStreamingAssetsHandoffJson.Serialize(value));
}
