...
internal static class EditDrivenGamePackageRuntimePreviewPlaythroughJson
{
...
internal static class EditDrivenGamePackageRuntimePreviewPlaythroughHash
{
    ...
    public static string HashJson<T>(T value) =>
        Sha256Text(EditDrivenGamePackageRuntimePreviewPlaythroughJson.Serialize(value));
}
