...
public sealed partial class VisualWorldStreamPreviewWorkspaceService
{
    private static VisualWorldStreamPreviewWorkspaceReport BuildReport(
        ...
        WithGoal135ReportFields(WithGoal134ReportFields(WithGoal132ReportFields(WithGoal131ReportFields(WithGoal130ReportFields(WithGoal129ReportFields(WithGoal128ReportFields(WithGoal127ReportFields(WithGoal126ReportFields(WithGoal125ReportFields(new()
        {
            Accepted = false,
        ...
        }, qualityGate), qualityGate), qualityGate), qualityGate), qualityGate), qualityGate), qualityGate), qualityGate), qualityGate), qualityGate);
}
