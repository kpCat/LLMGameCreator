...
public sealed partial class VisualWorldStreamPreviewWorkspaceService
{
    ...
    public VisualWorldStreamPreviewWorkspaceResult Build(string projectRootPath)
    {
        ...
        var groups = new List<VisualWorldPreviewArtifactGroup>
        {
            ...
            BuildGenericGamePackageLoopGroup(projectRoot, diagnostics),
            BuildGenericGamePackageSystemsGroup(projectRoot, diagnostics),
            BuildGenericGamePackageFullPlaythroughGroup(projectRoot, diagnostics),
            ...
            BuildCanonicalRuntimePlayerLoopReadinessGroup(projectRoot, diagnostics),
            BuildCanonicalRuntimePlayerCommandLoopGroup(projectRoot, diagnostics),
            ...
            BuildProductLineRuntimeVariantMatrixGroup(projectRoot, diagnostics)
        };
