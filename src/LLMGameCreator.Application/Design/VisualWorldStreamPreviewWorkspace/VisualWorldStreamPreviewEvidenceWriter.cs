...
public sealed partial class VisualWorldStreamPreviewWorkspaceService
{
        ...
        IReadOnlyList<VisualWorldPreviewDiagnostic> sourceDiagnostics)
    {
        ...
        var acceptedAlphaUnityPlayableProjection = BuildGoal119AcceptedAlphaUnityPlayableProjectionQuality(groups, proofs);
        ...
        var runtimeBackedUnityPlayerLoopStepper = BuildGoal138RuntimeBackedUnityPlayerLoopStepperQuality(groups, proofs); var runtimeBackedUnityPlayerLoopInteractiveControls = BuildGoal139RuntimeBackedUnityPlayerLoopInteractiveControlsQuality(groups, proofs);
        canonicalRuntimePlayerLoop = ResolveGoal135ReadinessFromCanonicalSuccessor(canonicalRuntimePlayerLoop, canonicalRuntimePlayerCommandLoop.QualityGatePassed || canonicalRuntimeUnityPlayerLoopPlayback.QualityGatePassed || runtimeBackedUnityPlayerLoopStepper.QualityGatePassed || runtimeBackedUnityPlayerLoopInteractiveControls.QualityGatePassed);
        ...
        AddGoal117AlphaPostAcceptanceContinuationQualityDiagnostics(postAcceptanceContinuation, binding, diagnostics);
        AddGoal118AcceptedAlphaBaselineQualityDiagnostics(acceptedAlphaBaseline, binding, diagnostics);
        AddGoal119AcceptedAlphaUnityPlayableProjectionQualityDiagnostics(acceptedAlphaUnityPlayableProjection, binding, diagnostics);
        ...
        AddGoal138RuntimeBackedUnityPlayerLoopStepperQualityDiagnostics(runtimeBackedUnityPlayerLoopStepper, binding, diagnostics); AddGoal139RuntimeBackedUnityPlayerLoopInteractiveControlsQualityDiagnostics(runtimeBackedUnityPlayerLoopInteractiveControls, binding, diagnostics);
        ...
        AddIfFalse(binding.PageBindDisplaysOfflineGeoworldAlphaExportPackage, "goal109.quality.winforms_offline_geoworld_alpha_export_package_binding", "winformsBinding", diagnostics);
        AddIfFalse(binding.PageBindDisplaysOfflineGeoworldAlphaManualAcceptance, "goal110.quality.winforms_offline_geoworld_alpha_manual_acceptance_binding", "winformsBinding", diagnostics);
        ...
        var baseQualityGate = new VisualWorldPreviewWorkspaceQualityGate
        {
            Accepted = false,
            Passed = passed,
            ...
            OfflineGeoworldInteractionActionKindCount = interactions.ActionKindCount,
            OfflineGeoworldInteractionActionCount = interactions.ActionCount,
            ...
            OfflineGeoworldSessionStateDeltaCount = sessionReplay.StateDeltaCount,
            OfflineGeoworldSessionCheckpointStepIndex = sessionReplay.CheckpointStepIndex,
            OfflineGeoworldSessionAcceptanceChecklistStepCount = sessionReplay.AcceptanceChecklistStepCount,
            OfflineGeoworldSessionFinalStateHash = sessionReplay.FinalStateHash,
            OfflineGeoworldSessionUnityScriptsReady = sessionReplay.UnityScriptsReady,
            OfflineGeoworldSessionEditorWindowReady = sessionReplay.EditorWindowReady,
            OfflineGeoworldSessionSimulatedReplayProofPassed = sessionReplay.SimulatedReplayProofPassed,
            OfflineGeoworldSessionNegativeProofPassed = sessionReplay.NegativeProofPassed,
        ...
        var withGoal138 = ApplyGoal138RuntimeBackedUnityPlayerLoopStepperQuality(withGoal137, runtimeBackedUnityPlayerLoopStepper, binding); return ApplyGoal139RuntimeBackedUnityPlayerLoopInteractiveControlsQuality(withGoal138, runtimeBackedUnityPlayerLoopInteractiveControls, binding);
    }
}
