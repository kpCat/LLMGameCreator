...
public sealed class GeneratorPlanCapabilitySelectionArtifactService
{
    ...
    private static string BuildMetadataJson(GeneratorPlanCapabilitySelectionResult result)
    {
        return JsonSerializer.Serialize(new
        {
            ...
            selectedModuleIds = result.Selection.SelectedModuleIds,
            selectedModifierIds = result.Selection.SelectedModifierIds,
            selectedConstraintIds = result.Selection.SelectedConstraintIds,
            runtimeRequirementIds = result.Selection.RuntimeRequirementIds,
