...
public sealed partial class VisualWorldStreamPreviewWorkspacePageControl : UserControl, IEditorPage
{
    ...
    private void BindDiagnostics(VisualWorldStreamPreviewWorkspaceResult result)
    {
        ...
        lines.AddRange(BuildAcceptedAlphaProjectionUsabilityDiagnosticLines(result));
        lines.AddRange(BuildAcceptedAlphaInteractionDrilldownDiagnosticLines(result));
        lines.AddRange(BuildAcceptedAlphaProjectionActionLoopDiagnosticLines(result));
        ...
        lines.AddRange(BuildUnityProjectionVerificationRunnerDiagnosticLines(result)); lines.AddRange(BuildParameterizedGamePackageRunnerDiagnosticLines(result)); lines.AddRange(BuildGamePackageCandidateMatrixDiagnosticLines(result)); lines.AddRange(BuildGamePackageCandidateFactoryDiagnosticLines(result));
    ...
    private static string BuildEntryDetails(VisualWorldPreviewArtifactEntry entry)
    {
        ...
        lines.AddRange(BuildAcceptedAlphaProjectionUsabilityEntryLines(entry));
        lines.AddRange(BuildAcceptedAlphaInteractionDrilldownEntryLines(entry));
        lines.AddRange(BuildAcceptedAlphaProjectionActionLoopEntryLines(entry));
        ...
        lines.AddRange(BuildUnityProjectionVerificationRunnerEntryLines(entry)); lines.AddRange(BuildParameterizedGamePackageRunnerEntryLines(entry)); lines.AddRange(BuildGamePackageCandidateMatrixEntryLines(entry)); lines.AddRange(BuildGamePackageCandidateFactoryEntryLines(entry));
